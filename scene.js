...
(function (root, factory) {
  ...
  function officeSvg() {
    return '<svg class="office" viewBox="0 0 600 180" preserveAspectRatio="xMidYMid slice" data-state="idle" data-hp="0" data-stress="0" aria-hidden="true" focusable="false">' +
      ...
      // All inside x 70-530, y 18-162, the part of the office every screen shape shows.
      ...
      '<g class="prop prop-framedstar"><rect x="495" y="26" width="22" height="22" rx="2" fill="#C98B3A"/><rect x="497.5" y="28.5" width="17" height="17" fill="#FFFFFF"/><path d="M506.0 30.0 L507.8 34.6 L512.7 34.8 L508.9 37.9 L510.1 42.7 L506.0 40.0 L501.9 42.7 L503.1 37.9 L499.3 34.8 L504.2 34.6 Z" fill="#F5B83D" stroke="#C98B3A" stroke-width="0.7"/></g>' +
